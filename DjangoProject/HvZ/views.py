...
def register_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # At this point, 'u' refers to the currently-being-registered user.
            # Likewise, 'p' refers to their player.
            p.playersetting.can_oz = form.cleaned_data['oz']
            p.playersetting.can_c3 = form.cleaned_data['c3']
        else:
